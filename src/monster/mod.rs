...
use crate::monster::damage::TestCol;
use crate::{animation::{AnimationIndices, AnimationTimer}, player::Player};

use self::monster_type::MonsterType;
use self::damage::{deal_damage_to_player, handle_damage_timer, DamageTimer};
...
impl Plugin for MonsterPlugin {
    fn build(&self, app: &mut bevy::prelude::App) {
        ...
        .add_systems(Update, (handle_enemy_spawn_timer, movement::move_to_player, handle_damage_timer, deal_damage_to_player));
    }
}
