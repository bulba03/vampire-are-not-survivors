...
impl MonstersData {
    pub fn construct(asset_server: Res<AssetServer>, texture_atlas_layouts:&mut Assets<TextureAtlasLayout>) -> Self {
        let bat = MonsterSpriteData::construct_from_type(MonsterType::Bat, asset_server.clone(), texture_atlas_layouts);
        let mushroom = MonsterSpriteData::construct_from_type(MonsterType::Mushroom, asset_server.clone(), texture_atlas_layouts);
        MonstersData {
            bat,
            mushroom
        }
    ...
    pub fn construct_from_type(
        ...
        -> Self {
            match m_type {
                ...
                MonsterType::Mushroom => mushroom_sprite_data(asset_server.clone(), texture_atlas_layouts),
            }
    }
}
